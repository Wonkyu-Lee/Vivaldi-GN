...
*   [Buildfile functions](#functions)
    ...
    *   [declare_overrides: Declare override build arguments.](#func_declare_overrides)
    ...
    *   [update_target: Add code to be run after setting up a target.](#func_update_target)
    *   [update_template_instance: Add code to be run after setting up a template instance.](#func_update_template_instance)
...
```
  ...
  have no effect.
```
### <a name="func_declare_overrides"></a>**declare_overrides**: Declare override build arguments.
...
```
### <a name="func_update_target"></a>**update_target**: Add code to be run after setting up a target.
```
...
```
### <a name="func_update_template_instance"></a>**update_template_instance**: Add code to a template instance.
